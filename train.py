...
def get_data(hps, sess):
    ...
    hps.n_y = {'mnist': 10, 'histo': 1, 'space': 1, 'cifar10': 10, 'imagenet-oord': 1000,
               'imagenet': 1000, 'celeba': 1, 'lsun_realnvp': 1, 'lsun': 1}[hps.problem]
    if hps.data_dir == "":
        hps.data_dir = {'mnist': None, 'histo': None, 'space': None, 'cifar10': None, 'imagenet-oord': '/local/ehoogebo/imagenet-oord-tfr', 'imagenet': '/mnt/host/imagenet-tfr',
    ...
    elif hps.problem in ['mnist', 'cifar10', 'histo', 'space']:
